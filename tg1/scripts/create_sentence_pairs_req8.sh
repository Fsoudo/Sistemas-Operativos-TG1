...
Resultado="/home/$USER/tg1/sentences_dict/sentences_pairs.txt"
MAX_WORDS=30
...
echo "A processar pares de frases do corpus..."

# Processar pares de frases com limite de 30 palavras (evita crash do Eugénio)
...
# awk: cria pares de frases consecutivas
# sort: ordena os pares
# uniq -c: conta ocorrências
# sed: remove espaços iniciais
# awk: reformata para "frase1 frase2 contagem"
